<template>
    <div :class="{ 'react-code-input-container': true, [className]: !!className }" :style="{ width: `${fields * fieldWidth}px` }">
        ...
        <div v-if="loading" class="loading" :style="{lineHeight: `${fieldHeight}px`}">
            <div class="blur" />
            <svg class="spin" viewBox="0 0 1024 1024" data-icon="loading" width="1em" height="1em" fill="currentColor" aria-hidden="true" >
